...
if os.path.isfile(params["input"]):
    file_initial = pandas.read_csv(params["input"])

    file_formatted = \
        file_initial.assign(structure_inchikey_2D=file_initial.structure_inchikey.str[0:13], reference_doi="")[[
            # 'structure_name',
    ...
    file_formatted.to_csv(params["output"])
